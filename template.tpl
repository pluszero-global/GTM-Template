...

{
  ...
  "version": 1,
  "securityGroups": [],
  "displayName": "GA4 Recommended Event Builder",
  "brand": {
    "id": "brand_dummy",
    "displayName": "",
  ...
  "description": "GA4 Recommended Event Builder Template.\n\nContain all of the official recommended GA4 Events \u0026 Parameters using dropdowns. Also able to add custom parameters.\n\nContact: pluszero@pluszero.co.kr",
  "containerContexts": [
    "WEB"
  ]
}
...
[
  ...
  },
  {
    ...
    "help": "Custom events are events that are not already automatically collected or recommended events. Custom events won\u0027t show up in most standard reports so you might want to register the custom parameters."
  },
  {
    "type": "SIMPLE_TABLE",
...
let parameters = data[eventType] ? makeTableMap(data[eventType], 'key', 'value') : undefined;
...
if(additional_parameters){
  if(parameters){
    ...
    for(var key in parameters){
      additional_parameters[key] = parameters[key];
    }
  } 
...
Created on 2021. 1. 4. 오전 11:41:27
